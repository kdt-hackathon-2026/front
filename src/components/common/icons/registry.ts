...
export const ICONS: Record<string, IconDef> = {
  ...
  close: { viewBox: '0 0 24 24', body: '<path d="M6 6l12 12M18 6 6 18" stroke="currentColor" stroke-width="2.2" stroke-linecap="round"/>' },
  'chevron-down': { viewBox: '0 0 24 24', body: '<path d="m6 9 6 6 6-6" fill="none" stroke="currentColor" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/>' },
  bell: { viewBox: '0 0 24 24', body: '<path d="M6 9a6 6 0 0 1 12 0v5l2 3H4l2-3V9Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M10 20h4" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>' },
  user: { viewBox: '0 0 24 24', body: '<circle cx="12" cy="8" r="4" fill="none" stroke="currentColor" stroke-width="2"/><path d="M4.5 21a7.5 7.5 0 0 1 15 0" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>' },
  users: { viewBox: '0 0 24 24', body: '<circle cx="9" cy="8" r="3" fill="none" stroke="currentColor" stroke-width="1.8"/><circle cx="17" cy="9" r="2.5" fill="none" stroke="currentColor" stroke-width="1.8"/><path d="M3 20a6 6 0 0 1 12 0M14 15a5 5 0 0 1 7 4.5" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>' },
  copy: { viewBox: '0 0 24 24', body: '<rect x="8" y="8" width="11" height="12" rx="2" fill="none" stroke="currentColor" stroke-width="2"/><path d="M16 8V6a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9a2 2 0 0 0 2 2h2" fill="none" stroke="currentColor" stroke-width="2"/>' },
  camera: { viewBox: '0 0 24 24', body: '<path d="M4 7h4l1.5-2h5L16 7h4v12H4V7Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><circle cx="12" cy="13" r="3.5" fill="none" stroke="currentColor" stroke-width="2"/>' },
  shield: { viewBox: '0 0 24 24', body: '<path d="M12 3 20 6v5c0 5-3.3 8.6-8 10-4.7-1.4-8-5-8-10V6l8-3Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="m8.5 12 2.2 2.2 4.8-4.8" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>' },
  history: { viewBox: '0 0 24 24', body: '<path d="M4 8V4m0 0h4M4 4l3.2 3.2A8 8 0 1 1 4.6 15" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 8v5l3 2" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>' },
  megaphone: { viewBox: '0 0 24 24', body: '<path d="M4 10v4h4l9 4V6L8 10H4Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="m8 14 1 6h3l-1-5" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/>' },
  gift: { viewBox: '0 0 24 24', body: '<rect x="3" y="9" width="18" height="12" rx="2" fill="none" stroke="currentColor" stroke-width="2"/><path d="M12 9v12M3 13h18M12 9H8.5A2.5 2.5 0 1 1 12 5.5V9Zm0 0h3.5A2.5 2.5 0 1 0 12 5.5V9Z" fill="none" stroke="currentColor" stroke-width="2"/>' },
  car: { viewBox: '0 0 24 24', body: '<path d="m5 10 2-5h10l2 5 2 2v6h-3v-2H6v2H3v-6l2-2Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><circle cx="7.5" cy="12.5" r="1.2" fill="currentColor"/><circle cx="16.5" cy="12.5" r="1.2" fill="currentColor"/>' },
  share: { viewBox: '0 0 24 24', body: '<circle cx="18" cy="5" r="3" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="6" cy="12" r="3" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="18" cy="19" r="3" fill="none" stroke="currentColor" stroke-width="2"/><path d="m8.7 10.7 6.6-4.2M8.7 13.3l6.6 4.2" stroke="currentColor" stroke-width="2"/>' },
  receipt: { viewBox: '0 0 24 24', body: '<path d="M6 3h12v19l-3-2-3 2-3-2-3 2V3Z" fill="none" stroke="currentColor" stroke-width="2" stroke-linejoin="round"/><path d="M9 8h6M9 12h6M9 16h4" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"/>' },
  building: { viewBox: '0 0 24 24', body: '<path d="M3 9 12 4l9 5M5 10v8M9 10v8M15 10v8M19 10v8M3 20h18" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>' },
